import datetime
from build_availability_xlsx import build_matrix
...
from suggest_timeslots import classify_timeslots
res = classify_timeslots(candidate_windows, 30, busy_map, {}, preemption_enabled=True, preemption_sensitivity=1.0)
slots_list = res["absolute_free"] + res["preemptable"]
build_matrix(slots_list, list(busy_map.keys()), "availability.xlsx")
