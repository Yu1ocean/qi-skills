...
<figure view-type="Card"><source name="team-travel-dashboard-generator.zip" href="https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=NjQzNjU3Mzc3MDIxYTdlYTE2MDRhODg0ZjlkYWFiOGRfOWQ1Mjc4ZDdhMjhhZTNiNGUxMTY1YzUzNTUyYjM2OTZfSUQ6NzY1MDc0MTc2NTEzMzM4ODk5M18xNzg1OTg4NTY2OjE3ODU5OTIxNjZfVjM" mime="application/zip" size="1193622" token="LnHMbklK7oPrcBxjVg8cBpjSnme"/></figure>

## 📌 技能简介

将 UK/EU/JP POP BD 团队的差旅审批邮件与商旅预订通知自动沉淀为结构化差旅资产：默认全量抓取可识别姓名的邮件，兼容单程票 / 多段链式行程，输出带【合规健康度雷达】、费用主卡常驻展示与强提醒特效的差旅大屏 V3.3，并补充 `output/mail_ledger.json` 作为 Email Logger 零信任 QA 审计台账。适用于团队差旅巡检、周会大屏、跨区域拜访排期复盘与合规风险扫描场景。
...
- 典型指令示例：
  ...
  > 抓近 3 个月差旅审批 / 预订邮件，给 UK/EU/JP POP BD 团队做一个自动化差旅大屏，并补齐周末差旅预警。升级团队差旅大屏，兼容多段链式行程去重，并额外产出一份可审计的邮件台账做 QA。
...
- **模板约束**：大屏必须包含数据总览、飞线总览、目的地热度、合规健康度雷达、Gantt 时间轴、明细表；首次差旅地需在地图 / 时间轴上做红色强提醒；V3.3 起行程详情中的原始 `\\n` 必须转为正常换行，`Message ID` 调试字段禁止继续出现在用户侧，费用金额需进入主卡常驻展示区。
...
<figure view-type="Card"><source name="team-travel-dashboard-generator.zip" href="https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZWM0NGNhZjY2OWIyNGI5ZjJiOTE4ZjQ1ZGQ1NGY3NGFfMWFmYzI4YjQ0NDFjMmMxMzQ5OWM3ZThlYmExODZiYzNfSUQ6NzY3MDc2MjQ4NTM0MzYzNjY2NV8xNzg1OTg4NTcxOjE3ODU5OTIxNzFfVjM" mime="application/zip" size="2111636" token="OjQQbZKegoRUtdxn0yUc3U3anwe"/></figure>

<figure view-type="Card"><source name="team-travel-dashboard-generator.zip" href="https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MjBjNWM2MDQwYTg3MTgyNmQ3NWQ3Zjk4ZTUzODM2OTZfZDMyOTIyMDMyYWIwYTEzNzJlMWU3YmE5ZDU5NWU2NGVfSUQ6NzY3MDc2MjYzMTAxNjA0MTQ1MF8xNzg1OTg4NjA1OjE3ODU5OTIyMDVfVjM" mime="application/zip" size="2111636" token="VZPLb1SrhobBktxbvt7cTrAlnRb"/></figure>